<template>
  ...
  <div>
    <DataTable
      ...
      show-index-symbol="$"
      :is-row-selectable="isRowSelectableFunction"
    >
...
const isRowSelectableFunction: IsRowSelectableFunction = (item: Item, index: number): boolean => item.number === 7;
